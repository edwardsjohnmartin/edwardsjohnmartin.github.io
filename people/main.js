...
let grads = [
  ...
  { image:'placeholder.jpg', size:165, name:'Rubash Mali (PhD)', bio:'Rubash is studying the effects of student awareness of current time-on-task when doing homework assignments. He\'s a pretty fantastic guy.' },
  { image:'placeholder.jpg', size:165, name:'Sulove Bhattarai (PhD)', bio:'Sulove is investigating how the use of AI while doing CS1 programming homework affects learning. You\'ll likely never meet a nicer fellow.' },
