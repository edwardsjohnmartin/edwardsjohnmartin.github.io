...
let grads = [
  ...
  { image:'', size:165, name:'Gordon Fjeldsted (Masters)', bio:""},
...
let undergrads = [
  ...
  { image:'', size:140, name:'Sally Devitry', bio:""}
];
