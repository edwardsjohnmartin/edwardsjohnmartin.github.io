...
let alumni = [
  { image:'ghimire.jpg', size:125, name:'Dr. Aashish Ghimire (PhD 2024)', bio:"Aashish studied all things AI relating to computing education, including the first study measuring student interactions with their code when they have access to ChatGPT. He has publications in AIED and i-ETC."},
  { image:'hart-kaden.jpg', size:125, name:'Dr. Kaden Hart (PhD 2024)', bio:"Kaden studied student behavior while computer programming, including an elegant study comparing behavior with and without cell phone notifications. He has publications in SIGCSE and JEDM."},
  { image:'urry-josh.jpg', size:125, name:'Josh Urry (M.S. 2024)', bio:"Josh studied cognitive load measured by pauses in keystrokes. He published in SIGCSE 2024." }, 
  { image:'syndergaard-caleb.jpg', size:125, name:'Caleb Syndergaard (M.S. 2024)', bio:'Caleb studied interventions to improve student perception of usage data being used for plagiarism detetction. He published in i-ETC 2024.' },
  { image:'brown-chris.jpg', size:125, name:'Chris Brown (M.S. 2023)', bio:"Chris worked on understanding of the processes students use while writing computer programs." },
//  { image:'hendricks-logan.jpg', size:165, name:'Logan Hendricks (Masters)', bio:'Logan completed a B.A. in Art History in 2013 from BYU-Idaho. He worked professionally in that field as a stained glass and glassblowing manager before making a transition to computer science. He graduated from the MTECH Web Development and Design certificate program in 2016. He worked professionally as a Full Stack Software Engineer and DevOps engineer for multiple years before starting the MS in Computer Science program in 2019. He is interested in the rise of Coding Bootcamps and is researching the difference in long term benefits of a traditional university degree when compared to a coding bootcamp.' },
  { image:'hendricks-logan.jpg', size:125, name:'Logan Hendricks (M.S. 2023)', bio:'Logan studied the rise of coding bootcamps, their long-term benefits, white-label bootcamps, and the differences in perception of bootcamps vs traditional university degrees. Preparation for publication is in progress.' },
  { image:'bagley-eric.jpg', size:125, name:'Eric Bagley (M.S. 2022)', bio:"Eric studied how using visual programming can help second grade students learn multiplication through iteration rather than algorithms typically taught in elementary school. Students loved the software! His work was published in ACE 2022."},
  { image:'shrestha.jpg', size:125, name:'Raj Shrestha (M.S. 2022)', bio:"Raj authored papers presented in ICSE 2021, 2022, and ACE 2022. He did a number of analyses of keystroke data looking at Circadian rhythms, pauses while programming, and the process of writing code."},
  { image:'johnson-marina.jpg', size:125, name:'Marina Johnson (M.S. 2022)', bio:"Marina first-authored a paper in the i-ETC conference looking at precision of thought between individuals who had been exposed to CS principles and those who had not."},
  { image:'willard-jaxon.jpg', size:125, name:'Jaxon Willard (B.S. 2022)', bio:"Jaxon did some excellent work looking at visualization strategies for complex, high-dimensional event data. He implemented the Needleman-Wunsch algorithm and designed other useful visualizations and algorithms for understanding various types of data."},
  { image:'scott-steven.jpg', size:125, name:'Steven Scott (B.S. 2022)', bio:"Steven graduated with majors in Computer Science and Economics and minors in Mathematics and Anticipatory Intelligence. His work on compilable state was published in ICSE SEET 2023."},
  { image:'devitry-sally.jpg', size:125, name:'Sally Devitry (B.S. 2021)', bio:"Sally is an URCO (Undergraduate Research & Creative Opportunities) grant recipient and developed a mobile application as a vehicle for reinforcing positive social-emotional skills in children. Her mobile book is an absolute delight. Ask her about Opto sometime."},
  { image:'', size:165, name:'Andres Imperial (M.S. 2021)', bio:"Andres attacked the problem of nonuniform noise in natural images. He designed and implemented a novel algorithm that clusters pixels in intensity space in order to compute meaningful statistics to determine correction offsets. He also created the first standard dataset that will be a great help in the field."},
  { image:'gonzales-stephanie.jpg', size:125, name:'Stephanie Gonzales (M.S. 2020)', bio:"Stephanie did research into the psychology of beginning computer science students in syntax exercises. Her empirical research using qualitative methods helps us understand what students think as they learn computer language syntax. She is currently preparing a paper for a submission to an international conference."},
