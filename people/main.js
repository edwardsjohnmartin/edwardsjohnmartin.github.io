...
let grads = [
  ...
  { image:'burns-matt.jpg', size:165, name:'Matt Burns (Masters)', bio:'Matt Burns is a Master student pursuing a degree in Data Science. He has an undergraduate degree in Biology from BYU - Idaho and discovered his love for data while working in an analytical chemistry lab.  He is looking forward to experiencing every step of the Data Science process, from collection to analysis, as he explores innovative methods of teaching problem decomposition in a CS1 context.' },
