...
let grads = [
  ...
  { image:'mali-rubash.jpg', size:165, name:'Rubash Mali (PhD)', bio:'Rubash is a PhD student in Computer Science studying student awareness of their current time-on-task when working on programming assignments. His research focuses on understanding how real-time feedback influences learning behaviors, productivity, and overall student performance. With a strong background in computer science and practical experience in teaching and educational technologies, Rubash is passionate about improving how students engage with programming tasks. Outside of his academic work, he enjoys traveling and exploring new cultures and experiences.' },
  { image:'bhattarai-sulove.jpg', size:165, name:'Sulove Bhattarai (PhD)', bio:'Sulove is a PhD student in Computer Science, originally from the beautiful town of Hetauda, Nepal. He completed his undergraduate studies in Electronics and Communication Engineering at Thapathali Campus, Tribhuvan University. He is excited to work with Dr. Edwards and is particularly interested in exploring how the rapid growth of large language model (LLM) tools is shaping student learning and educational practices. In his free time, Sulove enjoys both watching and playing soccer.' },
...
let alumni = [
  { image:'burns-matt.jpg', size:125, name:'Matt Burns', year:'(M.S. 2025)', bio:'Matt explored innovative methods of teaching problem decomposition in a CS1 context.' },
  { image:'hart-kaden-2.jpg', size:125, name:'Kaden Hart', year:'(B.S. 2025)', bio:'Kaden was a principal software engineer of the PhysMath physics simulation suite.' },
