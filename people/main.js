...
let grads = [
  ...
  { image:'placeholder.jpg', size:165, name:'Sadra Jafari Ghalehkohneh (PhD)', bio:"Sadra is studying physics education and is a principal engineer of the DynamicsLab physics simulation suite." },
  { image:'placeholder.jpg', size:165, name:'Matt Rau (Masters)', bio:'Matt is investigating student behaviors while programming.' },
  { image:'placeholder.jpg', size:165, name:'Matt Burns (Masters)', bio:'Matt is studying innovative methods of teaching problem decomposition in a CS1 context.' },
